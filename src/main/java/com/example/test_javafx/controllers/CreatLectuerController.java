...
public class CreatLectuerController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        ArrayList<Lecture> lectforCource = new ArrayList<Lecture>();
        for(Lecture s : DataModel.getCourseByname(dataModel.getWhoTeatcher()).getLectures()){
            courseforTeatcher.add(s.getCoursName());
        }
